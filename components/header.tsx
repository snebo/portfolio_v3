...
export default function Header() {
	...
	return (
		<header className="z-[900] relative">
			<motion.div
				className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-80 shadow-black/[0.3] backdrop-blur-[0.5rem] sm:top-6 sm:h-[2.8rem] sm:w-[36rem] sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75 dark:shadow-black/80"
						...
						>
							<Link
								className={clsx(
									...
									{ 'text-gray-950 dark:text-gray-200': activeSession === link.name }
								)}
								href={link.hash}
								onClick={() => {
